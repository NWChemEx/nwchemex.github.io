---
title: "Why is the NWChemEx API Written in Python?"
layout: single
permalink: /author/architecture/faqs/why_python/
toc: true
toc_sticky: true
---

The previous section, why_is_cxx_the_primary_language_of_nwchemex,
