...
layout: single
permalink: /author/devops/pre_commit/
toc: true
toc_sticky: true
---

[pre-commmit](https://pre-commit.com/) is a tool for configuring and
automating [githooks](https://git-scm.com/docs/githooks), which are a series
...
[NWChemEx/pre-commit-config](https://github.com/NWChemEx/pre-commit-config).
...
libraries (see development_python_development_workflow for more details).
...
within the [PluginPlay](https://github.com/NWChemEx/PluginPlay) library, you
