...
not part of the current design are noted here not-in-scope.
...
why_is_the_nwchemex_api_written_in_python.
...
access and modify the MPI communicator and toggle between 
CPU-based/GPU-offloaded algorithms.
...
The UI targets the most common use cases (see common-tasks), but should
...
PluginPlay [#308](https://github.com/NWChemEx/PluginPlay/issues/308)),
