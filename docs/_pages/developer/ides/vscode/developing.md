---
title: "Developing NWX with VSCode"
layout: single
permalink: /developer/ides/vscode/developing/
toc: true
toc_sticky: true
---
...
items?itemName=njpwerner.autodocstring) extension. Once the extension is
installed, set the `autoDocstring.docstringFormat` setting to "sphinx" to
match current NWX team python-coding-conventions.

> **Note:**
> Further information can be found [here](https://sphinx-rtd-tutorial.
> readthedocs.io/en/latest/docstrings.html#docstrings-in-vs-code).
