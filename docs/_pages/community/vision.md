...
The above will not happen by accident and requires careful planning and 
community efforts. To accomplish this goal, NWChemEx's overall design has 
heavily embraced two philosophies:
...
Decades of high-performance computing experience seem to suggest that these
philosophies are at odds. After all, there is a long history of achieving 
performance using tightly coupled code with little to no abstraction. The
result is . However many of the legacy high-performance codes were
