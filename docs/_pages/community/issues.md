...
[here](https://docs.github.com/en/get-started/quickstart/communicating-on-github).
...
[Main page](https://www.atlassian.com/software/jira).
...
issues_use_cases we rely on Issue templates. The Issue templates for the
