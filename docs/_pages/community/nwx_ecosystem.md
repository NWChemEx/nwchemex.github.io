...
layout: single
permalink: /developer/design/community/nwx_ecosystem/
toc: true
toc_sticky: true
---
...
"NWChemEx ecosystem" is defined as the nwx_community, software, and 
...
![Coarse overview of the NWChemEx software stack and its connections to other key stake holders in the broader community.](assets/nwx_ecosystem.png)
